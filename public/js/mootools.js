...
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/fd0711e3a57616d8c4603b27f549bcc8 
// Or build this file again with packager using: packager build More/Chain.Wait More/Slider
/*
---
copyrights:
  - [MooTools](http://mootools.net)
...
if(!c){return;}c.setOptions({link:"chain"});},this);return this;},pauseFx:function(c,b){this.chains(b).get(b||"tween").wait(c);return this;}});}})();Class.Mutators.Binds=function(a){if(!this.prototype.initialize){this.implement("initialize",function(){});
